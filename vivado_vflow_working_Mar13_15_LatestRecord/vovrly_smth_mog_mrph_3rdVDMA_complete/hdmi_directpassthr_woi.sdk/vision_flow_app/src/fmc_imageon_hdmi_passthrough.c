...
int fmc_imageon_hdmi_passthrough_init( fmc_imageon_hdmi_passthrough_t *pDemo )
{
  ...
  // while (1)
   ...
   //XVtc_WriteReg(pDemo->uBaseAddr_VTC_Axi4sTiming, XVTC_RESET, XVTC_RESET_RESET_MASK); // XVTC_RESET changed to XVTC_CTL and XVTC_RESET_RESET_MASK to XVTC_CTL_RESET_MASK by Majid
