 ...
 PARAMETER NAME = /export/scratch/fan/vivado/vivado_vflow_working_Feb20_15/vovrly_smth_mog_mrph_3rdVDMA_complete/hdmi_directpassthr_woi.sdk/app_cpu1_bsp/system.mss
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = mixtureofgaussians
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = bge_unit_MixtureOfGaussians_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axivdma
 PARAMETER DRIVER_VER = 5.0
 PARAMETER HW_INSTANCE = bge_unit_mog_vdma
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = axi_window_of_interest_detection
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = mog_woi_det
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = axi_window_of_interest_detection
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = video_overlay_unit_vovrlay_woi_det
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axivdma
 PARAMETER DRIVER_VER = 5.0
 PARAMETER HW_INSTANCE = video_overlay_unit_vovrly_vdma
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axivdma
 PARAMETER DRIVER_VER = 5.0
 PARAMETER HW_INSTANCE = ycbcr2mem_unit_ycbcr_vdma
END
