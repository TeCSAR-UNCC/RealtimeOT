...
HD_PWD='/home/work1/Documents/Vision_Project_WORKING_SET/vivado_vflow_working_Mar13_15_LatestRecord/vovrly_smth_mog_mrph_3rdVDMA_complete/hdmi_directpassthr_woi.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_directpassthr_woi_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source hdmi_directpassthr_woi_wrapper.tcl -notrace
