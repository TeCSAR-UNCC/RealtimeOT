...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.PCW_EN_CLK1_PORT {1} CONFIG.PCW_FPGA1_PERIPHERAL_FREQMHZ {150} CONFIG.PCW_USE_S_AXI_HP0 {1} CONFIG.preset {ZC702*}  ] $processing_system7_0
