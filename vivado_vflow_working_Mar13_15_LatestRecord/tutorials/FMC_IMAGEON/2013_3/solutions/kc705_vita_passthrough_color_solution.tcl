...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_m03_axi [get_bd_intf_pins fmc_imageon_vita_color/vita_ctrl] [get_bd_intf_pins microblaze_0_axi_periph/M03_AXI]
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_m05_axi [get_bd_intf_pins fmc_imageon_vita_color/dpc_ctrl] [get_bd_intf_pins microblaze_0_axi_periph/M05_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_m06_axi [get_bd_intf_pins fmc_imageon_vita_color/cfa_ctrl] [get_bd_intf_pins microblaze_0_axi_periph/M06_AXI]
  ...
  # Create port connections
  connect_bd_net -net axi4s_clk_1 [get_bd_pins clk_wiz_1/clk_out2] [get_bd_pins fmc_imageon_hdmio_rgb/axi4s_clk] [get_bd_pins fmc_imageon_vita_color/axi4s_clk]
  connect_bd_net -net clk_wiz_1_clk_out3 [get_bd_pins clk_wiz_1/clk_out3] [get_bd_pins fmc_imageon_vita_color/clk200]
  ...
  create_bd_addr_seg -range 0x10000 -offset 0x44A00000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs fmc_imageon_vita_color/fmc_imageon_vita_receiver_0/S00_AXI/Reg] SEG_fmc_imageon_vita_receiver_0_Reg
  ...
  create_bd_addr_seg -range 0x10000 -offset 0x44A30000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs fmc_imageon_vita_color/v_cfa_0/ctrl/Reg] SEG_v_cfa_0_Reg
  create_bd_addr_seg -range 0x10000 -offset 0x44A20000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs fmc_imageon_vita_color/v_spc_0/ctrl/Reg] SEG_v_spc_0_Reg
