...
proc create_root_design { parentCell } {
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net dpc_ctrl_1 [get_bd_intf_pins fmc_imageon_vita_mono/dpc_ctrl] [get_bd_intf_pins processing_system7_0_axi_periph/M03_AXI]
  connect_bd_intf_net -intf_net fmc_imageon_hdmio_y_hdmio_io [get_bd_intf_ports hdmio_io] [get_bd_intf_pins fmc_imageon_hdmio_y/hdmio_io]
  ...
  connect_bd_intf_net -intf_net fmc_imageon_vita_mono_vita_axi4s_video [get_bd_intf_pins fmc_imageon_hdmio_y/hdmio_axi4s_video] [get_bd_intf_pins fmc_imageon_vita_mono/vita_axi4s_video]
  connect_bd_intf_net -intf_net fmc_imageon_vita_mono_vita_vtiming [get_bd_intf_pins fmc_imageon_hdmio_y/video_vtiming] [get_bd_intf_pins fmc_imageon_vita_mono/vita_vtiming]
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_m02_axi [get_bd_intf_pins fmc_imageon_hdmio_y/vtc_ctrl] [get_bd_intf_pins processing_system7_0_axi_periph/M02_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_ddr [get_bd_intf_ports DDR] [get_bd_intf_pins processing_system7_0/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_fixed_io [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins processing_system7_0/FIXED_IO]
  connect_bd_intf_net -intf_net processing_system7_0_m_axi_gp0 [get_bd_intf_pins processing_system7_0/M_AXI_GP0] [get_bd_intf_pins processing_system7_0_axi_periph/S00_AXI]
  connect_bd_intf_net -intf_net vita_ctrl_1 [get_bd_intf_pins fmc_imageon_vita_mono/vita_ctrl] [get_bd_intf_pins processing_system7_0_axi_periph/M01_AXI]
  connect_bd_intf_net -intf_net vita_io_1 [get_bd_intf_ports vita_io] [get_bd_intf_pins fmc_imageon_vita_mono/vita_io]

  # Create port connections
  connect_bd_net -net axi4s_clk_1 [get_bd_pins fmc_imageon_hdmio_y/axi4s_clk] [get_bd_pins fmc_imageon_vita_mono/axi4s_clk] [get_bd_pins processing_system7_0/FCLK_CLK1]
  connect_bd_net -net clk200_1 [get_bd_pins fmc_imageon_vita_mono/clk200] [get_bd_pins processing_system7_0/FCLK_CLK2]
  ...
  connect_bd_net -net vita_clk_1 [get_bd_ports vita_clk] [get_bd_pins fmc_imageon_hdmio_y/hdmio_clk] [get_bd_pins fmc_imageon_vita_mono/vita_clk]
  ...
  create_bd_addr_seg -range 0x10000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs fmc_imageon_vita_mono/fmc_imageon_vita_receiver_0/S00_AXI/Reg] SEG_fmc_imageon_vita_receiver_0_Reg
  create_bd_addr_seg -range 0x10000 -offset 0x43C10000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs fmc_imageon_vita_mono/v_spc_0/ctrl/Reg] SEG_v_spc_0_Reg
  create_bd_addr_seg -range 0x10000 -offset 0x43C20000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs fmc_imageon_hdmio_y/v_tc_0/ctrl/Reg] SEG_v_tc_0_Reg
