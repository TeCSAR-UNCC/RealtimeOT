...
proc create_hier_cell_fmc_imageon_hdmio_yuv422 { parentCell nameHier } {
  ...
  connect_bd_net -net vcc_const [get_bd_pins fmc_imageon_hdmi_out_0/embed_syncs] [get_bd_pins fmc_imageon_hdmi_out_0/oe] [get_bd_pins v_axi4s_vid_out_0/aclken] [get_bd_pins v_axi4s_vid_out_0/aresetn] [get_bd_pins v_axi4s_vid_out_0/vid_io_out_ce] [get_bd_pins v_tc_0/clken] [get_bd_pins v_tc_0/det_clken] [get_bd_pins v_tc_0/resetn] [get_bd_pins v_tc_0/s_axi_aclken] [get_bd_pins vcc/const]
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.PCW_EN_CLK1_PORT {1} CONFIG.PCW_FPGA1_PERIPHERAL_FREQMHZ {150} CONFIG.preset {ZC702*}  ] $processing_system7_0
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net fmc_imageon_hdmii_yuv422_hdmii_axi4s_video [get_bd_intf_pins fmc_imageon_hdmii_yuv422/hdmii_axi4s_video] [get_bd_intf_pins fmc_imageon_hdmio_yuv422/hdmio_axi4s_video]
  connect_bd_intf_net -intf_net fmc_imageon_hdmii_yuv422_hdmii_vtiming [get_bd_intf_pins fmc_imageon_hdmii_yuv422/hdmii_vtiming] [get_bd_intf_pins fmc_imageon_hdmio_yuv422/video_vtiming]
  connect_bd_intf_net -intf_net fmc_imageon_hdmio_yuv422_hdmio_io [get_bd_intf_ports hdmio_io] [get_bd_intf_pins fmc_imageon_hdmio_yuv422/hdmio_io]
  ...
  connect_bd_intf_net -intf_net hdmii_io_1 [get_bd_intf_ports hdmii_io] [get_bd_intf_pins fmc_imageon_hdmii_yuv422/hdmii_io]
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_m01_axi [get_bd_intf_pins fmc_imageon_hdmio_yuv422/vtc_ctrl] [get_bd_intf_pins processing_system7_0_axi_periph/M01_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_ddr [get_bd_intf_ports DDR] [get_bd_intf_pins processing_system7_0/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_fixed_io [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins processing_system7_0/FIXED_IO]
  connect_bd_intf_net -intf_net processing_system7_0_m_axi_gp0 [get_bd_intf_pins processing_system7_0/M_AXI_GP0] [get_bd_intf_pins processing_system7_0_axi_periph/S00_AXI]

  # Create port connections
  connect_bd_net -net axi4s_clk_1 [get_bd_pins fmc_imageon_hdmii_yuv422/axi4s_clk] [get_bd_pins fmc_imageon_hdmio_yuv422/axi4s_clk] [get_bd_pins processing_system7_0/FCLK_CLK1]
  connect_bd_net -net fmc_imageon_hdmii_yuv422_hdmii_audio_spdif [get_bd_pins fmc_imageon_hdmii_yuv422/hdmii_audio_spdif] [get_bd_pins fmc_imageon_hdmio_yuv422/hdmio_audio_spdif]
  connect_bd_net -net fmc_imageon_iic_0_gpo [get_bd_ports fmc_imageon_iic_rst_n] [get_bd_pins fmc_imageon_iic_0/gpo]
  connect_bd_net -net hdmii_clk_1 [get_bd_ports hdmii_clk] [get_bd_pins fmc_imageon_hdmii_yuv422/hdmii_clk] [get_bd_pins fmc_imageon_hdmio_yuv422/hdmio_clk]
  ...
  connect_bd_net -net proc_sys_reset_peripheral_aresetn [get_bd_pins fmc_imageon_hdmio_yuv422/axi4lite_aresetn] [get_bd_pins fmc_imageon_iic_0/s_axi_aresetn] [get_bd_pins proc_sys_reset/peripheral_aresetn] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M01_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN]
  connect_bd_net -net processing_system7_0_fclk_clk0 [get_bd_pins fmc_imageon_hdmio_yuv422/axi4lite_clk] [get_bd_pins fmc_imageon_iic_0/s_axi_aclk] [get_bd_pins proc_sys_reset/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/M01_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK]
  ...
  create_bd_addr_seg -range 0x10000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs fmc_imageon_hdmio_yuv422/v_tc_0/ctrl/Reg] SEG_v_tc_0_Reg
