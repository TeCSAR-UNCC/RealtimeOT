...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net vtc_ctrl_1 [get_bd_intf_pins fmc_imageon_hdmio_rgb/vtc_ctrl] [get_bd_intf_pins processing_system7_0_axi_periph/M01_AXI]

  # Create port connections
  connect_bd_net -net axi4s_clk_1 [get_bd_pins fmc_imageon_hdmii_rgb/axi4s_clk] [get_bd_pins fmc_imageon_hdmio_rgb/axi4s_clk] [get_bd_pins processing_system7_0/FCLK_CLK1]
  ...
  connect_bd_net -net proc_sys_reset_peripheral_aresetn [get_bd_pins fmc_imageon_hdmio_rgb/axi4lite_aresetn] [get_bd_pins fmc_imageon_iic_0/s_axi_aresetn] [get_bd_pins proc_sys_reset/peripheral_aresetn] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M01_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN]
